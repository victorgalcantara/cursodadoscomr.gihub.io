...
# Extra I: unir bases de dados com chave de identificação comum
...
```{r}
# 1. Inicie seu código com cabeçalho e setup

# 2. Utilizando o pacote "rio", 
# importe os dados com os quais você irá trabalhar

# 3. Utilizando as funções de base
# Observe a estrutura da sua base de dados

# 4. Utilizando o pacote "tidyverse"
# Faça a seleção e filtro da sua base de dados

# 5. Utilizando o pacote "tidyverse"
...
# Extra II: começando a pensar na análise
