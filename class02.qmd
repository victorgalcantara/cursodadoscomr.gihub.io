# C2. Mãos na massa {.unnumbered}

>  *Costuma-se dizer que 80% do trabalho em análise de dados é limpando e preparando bases (Dasu e Johnson, 2003). Eles estão certos. Talvez seja até mais. Mas o conceito _data tidy_ e o pacote _tidyverse_ vieram para nos ajudar com isso* [@wickham2014, tradução livre, com muita liberdade mesmo, da p. 1]
...
setwd(dir = "C:/Users/sn1101492/OneDrive/02 - GitHub/cursodadoscomr.gihub.io/") # Define diretório principal de trabalho
...
br_uf_data <- import( "C:/Users/sn1101492/OneDrive/02 - GitHub/000 - P&R/00 data/br_uf.csv" )
```
...
```{r}
export(x = br_uf_data,
       file = "C:/Users/sn1101492/OneDrive/02 - GitHub//R-Intro/A02 - Explore II/0 - data/mydata.RDS")
```
