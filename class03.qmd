# C3. Mão na massa - Parte II {.unnumbered}
...
br_uf_data <- import( "C:/Users/victo/OneDrive/02 - GitHub/R-Intro/A03 - Mão na massa/00 data/br_uf.csv" )
```
...
```{r}
# 1. Crie um novo script em R 
# Inicie seu código com cabeçalho e setup

# 2. Faça a importação dos seus dados

# 3. Faça uma breve análise da estrutura dos dados
# Dimensões (dim), nomes de colunas (names), visualize as primeiras linhas (head) e a estrutura (str)

# Agora, como boa prática, vamos fazer o manuseio da base original guardando
# uma "versão manuseada" em um novo objeto

# Exemplo: se a sua base chama-se "escolas", você pode renomear como 
# "escolas_tratada" ou simplesmente "mydata"

# 4. Faça operações de seleção e filtragem encadeadas com pipe
# mydata <- escolas %>% select() %>% filter()

# 5. Compare as dimensões da base original com a base manuseada

# 6. Renomeie as colunas para que fiquem mais intuitivas e mantenham seu código limpo

# 7. Crie novas variáveis com transformações das originais utilizando R base e a função mutate
# Utilize as funções auxiliares para a transformação
...
# 8. Visualize a estrutura da sua base manuseada

# Estruturas condicionais (if, else, ifelse) e estruturas de repetição (for)

# 9. Crie um loop for para printar na tela os números de 0-10 

# Desafio!

# 10.  Crie um loop for para iterar sobre um vetor
# Exemplo: imprimir valores de uma coluna
# for (valor in mydata$nota) {
#   print(valor)
# }

# 11. Utilize um loop for para criar uma nova variável
# Exemplo: identificar alunos aprovados e reprovados
# 
# for (i in 1:nrow(mydata)) {
#   if (mydata$nota[i] >= 6) {
#     situacao_final[i] <- "Aprovado"
#   } else {
#     situacao_final[i] <- "Reprovado"
#   }
# }

# 12. Crie uma nova variável com base em uma condição simples usando ifelse()
# Exemplo: classificar alunos como "Aprovado" ou "Reprovado"
# mydata <- mydata %>%
#   mutate(situacao_final = ifelse(nota >= 6, "Aprovado", "Reprovado"))

# 13. Compare a abordagem com loop e com mutate para criar a situacao_final
# Aprovado/Reprovado

# Reflita: quando usar funções vetorizadas e quando usar for?
# (Dica: prefira mutate/ifelse sempre que possível para melhor desempenho e legibilidade)
