...
Você deve abrir algo parecido com a imagem abaixo. Uma das inovações deste ambiente de trabalho é dividir o fluxo em quatro janelas: 1) script; 2) console; 3) gestão de aquivos e *outputs* e; 4) ambiente global (gestão de memória).
...
![Passo 01 - Google Colab](images/step00%20-%20colab.png)

![Passo 2 - Google Colab](images/step01%20-%20colab.png)
